...
public class TrajectoryPlanner : MonoBehaviour
{
    ...
    [SerializeField]
    float m_ObstaclePublishRate = 50f; // How often to publish obstacle position (Hz) - INCREASED for low latency
    private float m_LastObstaclePublishTime = 0f;
    
    private string m_ObstaclePoseTopic = "/unity/obstacle_pose"; // Realtime pose topic
    ...
    void Start()
    {
        ...
        // Register realtime obstacle pose publisher for low-latency tracking
        m_Ros.RegisterPublisher<PoseMsg>(m_ObstaclePoseTopic);
